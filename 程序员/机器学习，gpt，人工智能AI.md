...
人工智能（Artificial Intelligence，简称 AI）和机器学习（Machine Learning，简称 ML）是两个密切相关但不同的概念。下面是它们的区别：

### 一、定义不同

* **人工智能（AI）：**
  是一个广义的概念，指的是**让机器具备类似人类智能的能力**，比如推理、学习、规划、理解语言、识别图像、做决策等。

* **机器学习（ML）：**
  是实现 AI 的一种方法，指的是**让机器通过数据学习模式和规律，从而自主改进性能**，而不是通过显式编程。
...
| 自动驾驶                 | ✅ AI  | ✅ ML  |
| 语音识别（如 Siri）         | ✅ AI  | ✅ ML  |
| 用 if-else 写的自动回复系统   | ✅ AI  | ❌ ML  |
| 推荐算法（如抖音、YouTube 推荐） | ✅ AI  | ✅ ML  |

### 五、小结一句话：

> **AI 是目标，ML 是方法。**
> AI 是让机器变“聪明”，ML 是用数据训练机器学会“聪明”的一种方式。
